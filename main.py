...
from forecast.trovoadas import verificar_trovoadas
from forecast.vento import verificar_vento_forte
from forecast.geada import verificar_geada
from forecast.enchentes import verificar_enchentes
from forecast.seca_ondas_de_calor import verificar_clima_seco_e_quente
from forecast.incendios import verificar_risco_incendio
    ...
    while True:
        ...
        try:
            ...
            if opcao == 8:
                ...
                verificar_clima_seco_e_quente(dados_climaticos)
                input("\nPressione qualquer tecla para voltar ao menu...")
                limpar_terminal()
